...
class EventReportingRequirement(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["startTs", "endTs"]
    ...
    @field_serializer("start_ts")
    def serialize_timestamp1(self, value, _info):
        return value.timestamp()

    @field_serializer("end_ts")
    def serialize_timestamp2(self, value, _info):
        return value.timestamp()
