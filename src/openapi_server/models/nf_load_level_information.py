...
class NfLoadLevelInformation(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "nfType": obj.get("nfType") if obj.get("nfType") is not None else None,
            "nfInstanceId": obj.get("nfInstanceId"),
            "nfSetId": obj.get("nfSetId"),
            "nfStatus": NfStatus.from_dict(obj.get("nfStatus")) if obj.get("nfStatus") is not None else None, # type: ignore
            ...
            "snssai": Snssai.from_dict(obj.get("snssai")) if obj.get("snssai") is not None else None, # type: ignore
